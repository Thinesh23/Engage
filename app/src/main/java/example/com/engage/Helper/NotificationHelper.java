package example.com.engage.Helper;
...
public class NotificationHelper extends ContextWrapper {
    ...
    @TargetApi(Build.VERSION_CODES.O)
    public Notification.Builder getFoodieChannelNotification(String title, String body, PendingIntent contentIntent,
                                                                         Uri soundUri){
        return new Notification.Builder(getApplicationContext(),UTP_CHANNEL_ID)
    ...
    @TargetApi(Build.VERSION_CODES.O)
    public Notification.Builder getFoodieChannelNotification(String title, String body,
                                                                         Uri soundUri){
        return new Notification.Builder(getApplicationContext(),UTP_CHANNEL_ID)
                .setContentTitle(title)
                .setContentText(body)
